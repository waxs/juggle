...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _js_setup_extends__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @js/setup/_extends */ \"./src/setup/_extends.js\");\n/* harmony import */ var _helper__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @helper */ \"./src/helpers/index.js\");\n/* harmony import */ var _method__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @method */ \"./src/methods/index.js\");\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); Object.defineProperty(Constructor, \"prototype\", { writable: false }); return Constructor; }\n\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\n/** ----------------------------------------\n    Setup\n ---------------------------------------- */\n\n/** ----------------------------------------\n    Core\n ---------------------------------------- */\n\nvar Core = /*#__PURE__*/_createClass(function Core() {\n  _classCallCheck(this, Core);\n});\n\n;\n/** ---------------------------------------- \n    Helpers\n ---------------------------------------- */\n\n\nObject(_js_setup_extends__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(Core, _helper__WEBPACK_IMPORTED_MODULE_1__[\"default\"]);\n/** ---------------------------------------- \n    Methods\n ---------------------------------------- */\n\n\nObject(_js_setup_extends__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(Core, _method__WEBPACK_IMPORTED_MODULE_2__[\"default\"]);\n/** ----------------------------------------\n    Exports\n ---------------------------------------- */\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (Core);\n\n//# sourceURL=webpack://Juggle/./src/Core.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _util_check_isType__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @util/check/_isType */ \"./src/util/check/_isType.js\");\n/** ----------------------------------------\n   Utilties\n---------------------------------------- */\n\n/** ----------------------------------------\n    Error\n ---------------------------------------- */\n\nvar error = function error(checks, message) {\n  var validated = !message || Object(_util_check_isType__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(checks) === 'array' ? checks.every(function (check) {\n    return check;\n  }) : checks;\n  if (validated) return console.error(message) && true;\n};\n/** ----------------------------------------\n    Export\n---------------------------------------- */\n\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (error);\n\n//# sourceURL=webpack://Juggle/./src/util/debug/_error.js?");
